...
export async function fetchUserData() {
  let body: any = await fetch("https://api.lanyard.rest/v1/users/1141690183977271377").then((res: any) => res.json());
  return body.data;
}
      ...
      <div className={``}>
        <div className="scale-[1] space-y-1 text-center md:scale-[1.2]">
          <div className="mb-2 flex items-center justify-center">
            <img
              src={`https://cdn.discordapp.com/avatars/1141690183977271377/${userData?.discord_user.avatar}.webp`}
              alt="User Avatar"
